...
#
#   #!/usr/bin/env bash
#   curl -s https://raw.githubusercontent.com/simonsdave/dev-env/release-0.5.7/ubuntu/xenial/create_dev_env.sh | bash -s -- "$@"
#   exit $?
#
# to test
#
...
curl -s --output Vagrantfile "https://raw.githubusercontent.com/simonsdave/dev-env/release-0.5.7/ubuntu/xenial/Vagrantfile"

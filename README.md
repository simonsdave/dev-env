...
[![Requirements](https://requires.io/github/simonsdave/dev-env/requirements.svg?branch=release-0.6.12)](https://requires.io/github/simonsdave/dev-env/requirements/?branch=release-0.6.12)
[![CodeFactor](https://www.codefactor.io/repository/github/simonsdave/dev-env/badge/release-0.6.12)](https://www.codefactor.io/repository/github/simonsdave/dev-env/overview/release-0.6.12)
[![CircleCI](https://circleci.com/gh/simonsdave/dev-env/tree/release-0.6.12.svg?style=shield)](https://circleci.com/gh/simonsdave/dev-env/tree/release-0.6.12)
[![codecov](https://codecov.io/gh/simonsdave/dev-env/branch/release-0.6.12/graph/badge.svg)](https://codecov.io/gh/simonsdave/dev-env/branch/release-0.6.12)

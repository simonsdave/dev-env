...
* [shell and python scripts](https://github.com/simonsdave/dev-env/tree/release-0.6.5/bin) are run on a developer's machine to access the dev env packaged in the docker image
...
* take a look at the [shell and python scripts](https://github.com/simonsdave/dev-env/tree/release-0.6.5/bin) to assess ```dev-env``` capability
* [here's](https://github.com/simonsdave/dev-env/tree/release-0.6.5/docs/using.md) a description of how to start using ```dev-env```
* take a look at [this](https://github.com/simonsdave/dev-env-testing) github repo which illustrates how to use ```dev-env```
* if you'd like to help contribute to ```dev-env``` see [this](https://github.com/simonsdave/dev-env/tree/release-0.6.5/docs/contributing.md)

...
[![Requirements](https://requires.io/github/simonsdave/dev-env/requirements.svg?branch=release-0.5.3)](https://requires.io/github/simonsdave/dev-env/requirements/?branch=release-0.5.3)
[![Build Status](https://travis-ci.org/simonsdave/dev-env.svg?branch=release-0.5.3)](https://travis-ci.org/simonsdave/dev-env)
...
* [here's](https://github.com/simonsdave/dev-env/tree/release-0.5.3/docs/using.md) a description of how to start using ```dev-env```
* if you'd like to help contribute to ```dev-env``` see [this](https://github.com/simonsdave/dev-env/tree/release-0.5.3/docs/contributing.md)

...
[![Requirements](https://requires.io/github/simonsdave/dev-env/requirements.svg?branch=release-0.6.8)](https://requires.io/github/simonsdave/dev-env/requirements/?branch=release-0.6.8)
[![CodeFactor](https://www.codefactor.io/repository/github/simonsdave/dev-env/badge/release-0.6.8)](https://www.codefactor.io/repository/github/simonsdave/dev-env/overview/release-0.6.8)
[![CircleCI](https://circleci.com/gh/simonsdave/dev-env/tree/release-0.6.8.svg?style=shield)](https://circleci.com/gh/simonsdave/dev-env/tree/release-0.6.8)
[![codecov](https://codecov.io/gh/simonsdave/dev-env/branch/release-0.6.8/graph/badge.svg)](https://codecov.io/gh/simonsdave/dev-env/branch/release-0.6.8)
